...
with open("example.yaml", "r") as stream:
    try:
        ...
        print(exc)
py ./app/main_interactive.py --config configs/mesh.yaml --dataset-path D:/workspace/INTEGRATION/kaolin-wisp/data/test/results_test_nored_200
...
mesh_args = Object()
mesh_args.nef_type = 'NeuralSDF'   
mesh_args.num_lods = 6
mesh_args.base_lod = 2 
mesh_args.samples_per_voxel = 32
mesh_args.num_samples = 5000
mesh_args.epochs = 10
mesh_args.batch_size = 512
mesh_args.save_every = -1
mesh_args.render_every = -1
mesh_args.valid_every =  -1
mesh_args.num_samples_on_mesh = 10000
mesh_args.tracer_type = 'PackedSDFTracer'
mesh_args.sample_mode = ['rand', 'near', 'near', 'trace', 'trace']
mesh_args.camera_clamp=[0, 10] 
mesh_args.camera_fov=30
mesh_args.camera_lookat=[0, 0, 0]
mesh_args.camera_origin=[-2.8, 2.3, -2.8]
mesh_args.camera_proj='persp'
mesh_args.codebook_bitwidth=8
mesh_args.config='configs/nglod_sdf_interactive.yaml'
mesh_args.dataset_num_workers=-1,
mesh_args.dataset_path='D:/workspace/INTEGRATION/kaolin-wisp/data/test/obj/1.obj'
mesh_args.dataset_type='sdf'
mesh_args.decoder_type='basic', 
mesh_args.detect_anomaly=False
mesh_args.embedder_type='none'
mesh_args.epochs=10
mesh_args.exp_name='test-nglod-sdf-interactive'
mesh_args.feature_bias=0.0
mesh_args.feature_dim=16
mesh_args.feature_std=0.01
mesh_args.get_normals=False
mesh_args.grid_lr_weight=1.0
mesh_args.grid_type='OctreeGrid'
mesh_args.grow_every=-1
mesh_args.growth_strategy='increase'
mesh_args.hidden_dim=128
mesh_args.interpolation_type='linear'
mesh_args.layer_type='none'
mesh_args.log_2d=True
mesh_args.log_dir='_results/logs/runs/'
mesh_args.log_level=20
mesh_args.lr=0.001 
mesh_args.matcap_path='data/matcaps/matcap_plastic_yellow.jpg'
mesh_args.max_grid_res=2048
mesh_args.min_dis=0.0003
mesh_args.mip=None
mesh_args.mode_mesh_norm='sphere'
mesh_args.model_format='full'
mesh_args.multiscale_type='sum'
mesh_args.multiview_dataset_format='standard'
mesh_args.nef_type='NeuralSDF'
mesh_args.noise_std=0.0
mesh_args.num_layers=1
mesh_args.num_lods=6
mesh_args.num_rays_sampled_per_img=4096
mesh_args.num_samples=5000
mesh_args.num_samples_on_mesh=10000
mesh_args.num_steps=128
mesh_args.only_last=True
mesh_args.optimizer_type='adam'
mesh_args.out_dim=1
mesh_args.perf=False
mesh_args.pos_multires=10
mesh_args.position_input=True
mesh_args.pretrained=None
mesh_args.prune_every=-1
mesh_args.random_lod=False
mesh_args.raymarch_type='voxel'
mesh_args.render_batch=0
mesh_args.render_every=-1 
mesh_args.render_res=[1024, 1024]
mesh_args.resample=True
mesh_args.resample_every=1
mesh_args.rgb_loss=1.0
mesh_args.sample_mode=['rand', 'near', 'near', 'trace', 'trace'] 
mesh_args.sample_tex=False
mesh_args.samples_per_voxel=32
mesh_args.save_as_new=False
mesh_args.save_every=-1
mesh_args.shading_mode='matcap'
mesh_args.shadow=True
mesh_args.skip=None
mesh_args.step_size=0.8 
mesh_args.tracer_type='MeshRasterer'
mesh_args.trainer_type='MeshTrainer'
mesh_args.tree_type='quad'
mesh_args.valid_every=-1
mesh_args.valid_only=False 
mesh_args.view_multires=4
mesh_args.weight_decay=0
...
if __name__ == "__main__":
    ...
    mesh_args.matrix = torch.Tensor( M_data)
    pipeline1, train_dataset1, device = get_modules_from_config(mesh_args)
    ...
    trainerSDf = globals()[mesh_args.trainer_type](pipeline1, train_dataset1, 
                                     mesh_args.epochs, 
                                     mesh_args.batch_size,
                                      optim_cls, 
                                      mesh_args.lr, 
                                      mesh_args.weight_decay,
                                      mesh_args.grid_lr_weight, 
                                      optim_params, 
                                      mesh_args.log_dir, 
                                      device,
                                      exp_name=mesh_args.exp_name, 
                                      info=args_str, 
                                      extra_args=sdF_arg_dict,
                                      render_every=mesh_args.render_every, 
                                      save_every=mesh_args.save_every,
